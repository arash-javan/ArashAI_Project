function [TestResult,TrainResult]=RNN(X,Y,No_of_folds,i,p,o)
...
for K =1 : No_of_folds
    ...
    net3 = layrecnet(1:2,[25 12 5]);
    net3.divideParam.valRatio = 5/100;
    net3.trainParam.epochs=1000;
    net3.trainParam.max_fail=60;
    net3.trainParam.sigma=5.0e-7;
    net3.trainParam.lambda=5.0e-5;
    ...
    statsTest = confusionmatStats(Ytestini,round(Yh));
